...
public class IventController {
    ...
    //переделать это дерьмо, добавить айдишник.
    @GetMapping("/getNearIvents/{id}")
    public List<Ivent> getNearIvents(@PathVariable(value = "id") long id){
        ...
        return iventRepositories.findTop7ByDayAfterOrMonthAfterAndUserId(day, month, id);
    }
}
